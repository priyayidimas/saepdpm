...
<div class="container">
       ...
       <div class="card">
           <div class="card-body">
               ...
               <form action="{{url('file')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="md-form">
                    <textarea id="textarea-char-counter" name="txt" class="form-control md-textarea" rows="3" length="120"></textarea>
                    <label for="textarea-char-counter">Text</label>
                </div>
                <div class="md-form">
    ...
    <div class="row mb-5">
        <div class="card w-100">
            <div class="card-body" id="form-bap">
                ...
                @endphp
                    <div class="tab-pane fade in {{$a = ($s->id == 1) ? 'show active' : '' }}" id="section{{$s->id}}" role="tabpanel">
                        ...
                        <table class="table table-responsive-sm table-bordered form-body">
                            <tr>
                                <th>Kriteria</th>
