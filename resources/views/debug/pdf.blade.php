@php
    ...
    $path = url('assets/img/KangHilmi.png');
    $type = pathinfo($path, PATHINFO_EXTENSION);
    $data = file_get_contents($path, false, stream_context_create($arrContextOptions));
    $base64 = 'data:image/'.$type.';base64,'.base64_encode($data);

    $path1 = url('assets/img/LogoRed.png');
    ...
    <body>
        ...
        <table style="width:100%">
            ...
            <tr>
                <td style="width:30%"></td>
                <td style="width:40%">
                    <img src="{{$base641}}" alt="" style="height:120px; z-index:20; position:absolute">
                    <img class="foto-ttd ttd-container" src="{{$base64}}" alt="" style="position:relative;">
                </td>
                <td style="width:30%">
                    <img class="foto-ttd" src="{{$base64}}" alt="">
                </td>
            </tr>
            <tr>
                <td style="width:30%"></td>
