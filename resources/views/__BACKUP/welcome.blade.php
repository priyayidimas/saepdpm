...
<head>
    ...
    <title>DPM SAEP &middot; Login</title>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="text-center mb-5">
                    <img src="{{url('/assets/img/icon.png')}}" width="150" height="150" class="mb-2 img-fluid rounded-circle z-depth-1-half" alt="">
                    <h4 class="display">Sistem Asesmen dan Evaluasi Proker</h4>
                </div>
                {{-- @if (session('msg'))
                    <div class="card mb-5">
