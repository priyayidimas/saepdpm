...
@section('content')
<div class="container">
    <form action="{{route('insertBAPProker')}}" method="POST" id="formBap">
    @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form">
                                    ...
                                    <input type="text" name="pengawas_nim" id="form1" class="form-control" minlength="2" required>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form">
                                    ...
                                    <input type="text" name="pengawas_nama" id="form1" class="form-control" minlength="2" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="form[{{$f->id}}]" type="radio" id="form{{$f->id}}o1" value="1">
                                ...
                                <td>
                                    @if ($f->n2 != 0)
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="form[{{$f->id}}]" type="radio" id="form{{$f->id}}o2" value="2">
                                ...
                                <td>
                                    @if ($f->n3 != 0)
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="form[{{$f->id}}]" type="radio" id="form{{$f->id}}o3" value="3">
                                ...
                                <td>
                                    @if ($f->n4 != 0)
                                    <fieldset class="form-check">
                                        <input class="form-check-input" name="form[{{$f->id}}]" type="radio" id="form{{$f->id}}o4" value="4">
